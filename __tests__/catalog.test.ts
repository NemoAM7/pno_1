...
const products: Product[] = [
  {
    ...
    currency: 'INR', images: [], materials: ['mesh'], isFeatured: true, isInStock: true, isCustomizable: false,
    variants: [{ id: 'one-black-9', color: 'Black', size: 'UK 9', sku: 'ONE-9' }],
  },
  {
    id: 'two', slug: 'two', name: 'Beta Trainer', categoryId: 'footwear', description: 'Stable shoe', priceCents: 15000,
    currency: 'INR', images: [], materials: ['rubber'], isFeatured: false, isInStock: true, isCustomizable: false,
    variants: [{ id: 'two-white-10', color: 'White', size: 'UK 10', sku: 'TWO-10' }],
  },
];
